...
('2','batcave','clean vehicles','Need to get all the junkfood and blood from inside the vehicle, and spray off the outside','false'),
('3','jewlrey store','steal jewlrey','need new jewley to match my babies collars','false'),
('4','office','help Scarecrow','find out what Scarecrow keeps his gas *FOR JOKER*','false'),
('1','bruce manor','do Bruce Wanye things','sign paperwork, send emails, kiss babies','false'),
('2','batcave','feed bats','bats gotta eat','false'),
('3','jewlrey store','steal gems','need gems for new kitty collars','false'),
('4','arkam asylum','set JOKER free','break out JOKER after I get all the info he needs!','false')
